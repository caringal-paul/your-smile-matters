// BookingRescheduleFormModal.tsx
...
type BookingRescheduleFormModalProps = {
	open: boolean;
	...
	>;
	selectedBooking: GetByIdBookingResponseAmi;
};

export const BookingRescheduleFormModal = ({
	open,
	onOpenChange,
	onSubmit,
	form: rescheduleForm,
	selectedBooking,
}: BookingRescheduleFormModalProps) => {
	const {
						...
						<DialogFooter className="flex flex-row gap-1">
							<Button
								...
								disabled={
									...
									!rescheduleForm.getValues("photographer_id")
								}
								onClick={onSubmit}
							>
								Continue
