			...
			<SectionHeader className="flex justify-start mb-4">
				<div>
					<Label className="flex flex-row flex-wrap items-center gap-1 font-normal text-md">
						...
						>
							<BackIcon fill="#1C1B1F" className="w-4 h-4" /> Photographers List
						</Button>
						<ChevronRight className="w-4 h-4" />{" "}
						<span className="text-admin-secondary">Photographer Details</span>
					</Label>
				</div>
			</SectionHeader>
...
export default PhotographerBreadcrumbs;
