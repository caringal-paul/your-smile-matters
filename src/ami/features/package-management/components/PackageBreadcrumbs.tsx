			...
			<SectionHeader className="flex justify-start mb-4">
				<div>
					<Label className="flex flex-row flex-wrap items-center gap-1 font-normal text-md">
						<Button
							variant={"icon"}
							onClick={() => navigate("/admin/ami/package-management/packages")}
							className="px-2 font-normal hover:bg-transparent text-md"
						>
							<BackIcon fill="#1C1B1F" className="w-4 h-4" /> Packages
						</Button>
						<ChevronRight className="w-4 h-4" />{" "}
						<span className="text-admin-secondary">Package Form</span>
					</Label>
				</div>
			</SectionHeader>
...
export default PackageBreadcrumbs;
