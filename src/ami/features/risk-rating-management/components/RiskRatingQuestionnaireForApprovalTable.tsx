...
import riskRatingQuestionnaireForApproval from "../mock/temp-risk-rating-questionnaire-for-approval.json";
...
import { useRiskRatingQuestionnaireForApprovalColumns } from "../utils/columns/risk-rating-questionnaire-for-approval.columns";
import { RISK_RATING_QUESTIONNAIRE_FOR_APPROVAL_TABLE_SEARCH_KEYS } from "../constants/risk-rating-questionnaire.constants";
import { useState } from "react";
import ConfirmModal from "@/ami/shared/components/custom/modal/ConfirmModal";

const RiskRatingQuestionnaireForApprovalTable = () => {
	const riskRatings = riskRatingQuestionnaireForApproval as unknown;

	const [isApproveModalOpen, setIsApproveModalOpen] = useState(false);
	const [isRejectModalOpen, setIsRejectModalOpen] = useState(false);

	const customersDriskRatingsData =
		riskRatings as RiskRatingQuestionnaireForApprovalTableType[];
	const columns = useRiskRatingQuestionnaireForApprovalColumns({
	...
	const {
		...
		applyFilters,
		filteredData,
	} = useFilteredTableData<RiskRatingQuestionnaireForApprovalTableType>({
		data: customersDriskRatingsData,
		keys: RISK_RATING_QUESTIONNAIRE_FOR_APPROVAL_TABLE_SEARCH_KEYS,
...
export default RiskRatingQuestionnaireForApprovalTable;
