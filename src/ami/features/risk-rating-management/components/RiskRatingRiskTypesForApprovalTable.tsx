...
import riskRatingRiskTypesForApproval from "../mock/temp-risk-rating-risk-types-for-approval.json";
...
import { useRiskRatingRiskTypesForApprovalColumns } from "../utils/columns/risk-rating-risk-types-for-approval.columns";

const RiskRatingRiskTypesForApprovalTable = () => {
	const riskRatings = riskRatingRiskTypesForApproval as unknown;

	const [isApproveModalOpen, setIsApproveModalOpen] = useState(false);
	const [isRejectModalOpen, setIsRejectModalOpen] = useState(false);

	const customersDriskRatingsData =
		riskRatings as RiskRatingRiskTypesForApprovalTableType[];
	const columns = useRiskRatingRiskTypesForApprovalColumns({
	...
	const {
		...
		applyFilters,
		filteredData,
	} = useFilteredTableData<RiskRatingRiskTypesForApprovalTableType>({
...
export default RiskRatingRiskTypesForApprovalTable;
