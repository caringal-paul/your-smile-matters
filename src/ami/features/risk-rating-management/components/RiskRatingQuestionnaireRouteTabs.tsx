...
import { RISK_RATING_QUESTIONNAIRE_TAB_ROUTES } from "../constants/risk-rating-questionnaire.constants";

const RiskRatingQuestionnaireRouteTabs = () => {
			...
			<div className="flex">
				...
				>
					<TabsList className="my-5 xl:my-4">
						{RISK_RATING_QUESTIONNAIRE_TAB_ROUTES.map((route: TabRoute) => {
							return (
								<TabsTrigger
									key={route.id}
									value={route.value}
...
export default RiskRatingQuestionnaireRouteTabs;
