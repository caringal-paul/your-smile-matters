...
import { RiskRatingQuestionnaireForApprovalTableType } from "../types/risk-rating-questionnaire-for-approval.types";
...
export const useRiskRatingQuestionnaireForApprovalColumns = ({
	setIsRejectModalOpen,
	setIsApproveModalOpen,
}: CustomerForApprovalProps): Column<RiskRatingQuestionnaireForApprovalTableType>[] => {
	const columns: Column<RiskRatingQuestionnaireForApprovalTableType>[] = [
		{
			key: "date_requested",
