...
const EditUserForm = () => {
	...
	const form = useForm<UserAmiUpdate>({
		...
		defaultValues: {
			...
			first_name: userWithRolesAndPermissions?.first_name ?? "",
			last_name: userWithRolesAndPermissions?.last_name ?? "",
			mobile_number: userWithRolesAndPermissions?.mobile_number ?? "",
			is_active: userWithRolesAndPermissions?.is_active ?? false,
			role_id: userWithRolesAndPermissions?.role_id ?? "",
		},
	});
