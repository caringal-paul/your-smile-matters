...
import { useGetMyBookingRequestsQuery } from "../queries/getMyBookingRequests.sf.query";
...
const MyBookingRequests = () => {
	...
	const columns = useMyBookingRequestsColumns();
	...
	const {
		...
		setDateFilterDraft,
		filteredData,
	} = useFilteredTableData<MyBookingRequestsSfTableType>({
		data: bookings,
		keys: MY_BOOKING_REQUESTS_TABLE_SEARCH_KEYS,
