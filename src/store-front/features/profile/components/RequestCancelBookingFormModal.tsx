// RequestCancelBookingFormModal.tsx
...
interface RequestCancelBookingFormModalProps {
	open: boolean;
...
export const RequestCancelBookingFormModal = ({
	open,
	onOpenChange,
	onSubmit,
	form: cancelForm,
}: RequestCancelBookingFormModalProps) => {
	return (
					...
					<form className="flex flex-col gap-3">
						...
						<DialogFooter className="flex flex-row gap-1">
							<Button
								...
								className="w-full"
								disabled={
									String(cancelForm.getValues("cancellation_reason")).length >
									500
								}
								onClick={onSubmit}
							>
